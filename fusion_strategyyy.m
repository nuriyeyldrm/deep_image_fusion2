function [gen, ave1, ave2] = fusion_strategyyy(features_a, features_b, source_a, source_b, img1, img2, unit)
...
gen = source_a.*weight_ave_temp1 + source_b.*weight_ave_temp2 + img1.*weight_ave_temp3 + img2.*weight_ave_temp4;
