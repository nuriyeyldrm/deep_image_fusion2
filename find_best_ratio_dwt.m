function [ratio, nabf] = find_best_ratio_dwt(image1, image2)
...
for i=1:+0.1:2
    ...
    [F_saliency_relu1, l1_featrues_relu1_ave_a, l1_featrues_relu1_ave_b] = ...
                fusion_strategy_dwt(l1_featrues_relu1_a, l1_featrues_relu1_b,...
    ...
    [F_saliency_relu2, l1_featrues_relu2_ave_a, l1_featrues_relu2_ave_b] = ...
                fusion_strategy_dwt(l1_featrues_relu2_a, l1_featrues_relu2_b,...
    ...
    [F_saliency_relu3, l1_featrues_relu3_ave_a, l1_featrues_relu3_ave_b] = ...
                fusion_strategy_dwt(l1_featrues_relu3_a, l1_featrues_relu3_b,...
    ...
    [F_saliency_relu4, l1_featrues_relu4_ave_a, l1_featrues_relu4_ave_b] = ...
                fusion_strategy_dwt(l1_featrues_relu4_a, l1_featrues_relu4_b,...
